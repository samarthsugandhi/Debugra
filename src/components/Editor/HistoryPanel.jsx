          ...
          history.map((item) => (
            <div key={item.id} className="history-item p-2 mb-2 rounded border border-transparent bg-hover transition-all">
              ...
              <div className="history-item-actions d-flex gap-2 mt-2">
                ...
                <button onClick={() => handleRename(item.id, item.name || 'untitled')} className="btn btn-sm btn-outline-warning x-small d-flex align-items-center justify-content-center py-1" title="Rename">
                  <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7" />
                    <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z" />
                  </svg>
                </button>
                <button onClick={() => handleDelete(item.id)} className="btn btn-sm btn-outline-danger x-small d-flex align-items-center justify-content-center py-1" title="Delete">
                  <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
